...
public class ConfirmMoveGui {
    ...
    public static Gui createGui(Steward steward, Player player) {
        Gui gui = Gui.gui().title(Component.text("Steward"))
            .type(GuiType.HOPPER)
            .create();
    ...
    private static void populateButtons(Gui gui, Steward steward, Player player){
        ...
        backMeta.customName(ColorParser.of("<green>Go back!").build());
        ...
        stayMeta.customName(ColorParser.of("<green>Stay here!").build());
        ...
        continueMeta.customName(ColorParser.of("<green>Keep following!").build());
